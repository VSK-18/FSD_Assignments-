    ...
    <div className="container">
      ...
      <nav className="nav glass-card mb-12">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-black tracking-tight uppercase">Feedback<span className="text-primary">Sys</span></h1>
            <p className="text-xs text-text-muted font-medium">Student Performance System</p>
          </div>
        </div>
      ...
      <footer className="mt-20 text-center text-text-muted text-sm border-t border-white/5 pt-8 pb-12">
        <p>© 2026 Student Feedback System. Built with MERN Stack • MongoDB • Express • React</p>
      </footer>
    </div>
  );
}
